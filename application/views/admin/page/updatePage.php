                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="page_title" value="<?php echo $PageInfoById[0]->title; ?>">
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    ...
                                    <select class="form-control" name="parentId">
                                        ...
                                        foreach($pages->result() as $page)
                                        {
                                            ...
                                            <option value="<?php echo $page->id; ?>" 
                                                <?php
                                                $idToBeChecked = $PageInfoById[0]->parent_id;
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <textarea class="form-control ckeditor" name="editor"><?php echo $PageInfoById[0]->page_content; ?></textarea>
                                    </div>
